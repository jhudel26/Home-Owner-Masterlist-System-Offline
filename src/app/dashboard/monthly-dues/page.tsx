...
export default function MonthlyDuesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-teal-500/20 bg-gradient-to-br from-[#06182a] via-[#092238] to-[#0d2e4c] text-white p-6 md:p-8 shadow-xl">
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          {/* Left: HOA Profile Picture & Info */}
          <div className="flex items-center gap-4 sm:gap-5">
            <div className="relative h-16 w-16 sm:h-20 sm:w-20 rounded-2xl overflow-hidden border-2 border-teal-400/40 shadow-lg bg-[#04101d] shrink-0 flex items-center justify-center p-1 group">
              <img
                src="/icon.png"
                alt="HOA Logo"
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-1">
                <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-teal-300 bg-teal-950/70 border border-teal-500/30 px-2.5 py-0.5 rounded-full">
                  Phase 4 HOA Portal
                </span>
          ...
          <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center justify-center gap-1.5 mt-0.5">
                ...
                {canManageDues && (
                  <button
                    ...
                    className="p-1 rounded-md text-teal-300 hover:text-white hover:bg-white/10 transition-colors"
                  >
            ...
            <div className="px-4 py-2.5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 text-center min-w-[100px]">
              ...
              <span className="text-base sm:text-lg font-extrabold text-teal-300 font-mono block mt-0.5">
                {collectionRate}%
              </span>
            </div>
            ...
            {canManageDues && (
              <Button
                ...
                className="rounded-2xl border-teal-400/40 bg-teal-500/20 hover:bg-teal-500/30 text-teal-100 hover:text-white text-xs font-bold gap-1.5 h-10 px-4"
              >
        ...
        <form onSubmit={handleSaveRate} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-base font-bold text-teal-600">
                ₱
              </span>
              <Input
                type="number"
